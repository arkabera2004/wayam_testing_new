...
const isPublic = createRouteMatcher([
  ...
  "/signup(.*)",
  "/api/health",
  // The demo storefront is the system under test, not part of the product's
  // authenticated surface. Behind the wall, every generated spec navigates
  // into a redirect to /login and the whole suite fails.
  "/demo(.*)",
]);
